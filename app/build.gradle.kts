...
configurations.all {
    // Two BouncyCastle distributions collide (bc*-jdk15to18 vs bc*-jdk18on) -> duplicate
    // classes at checkDebugDuplicateClasses. Keep the modern jdk18on variant (build is JDK 21).
